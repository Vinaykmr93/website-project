    ...
    <div>
        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
                ...
                <input type="text" v-model="user.address" v-validate="'required'" name="address" class="form-control" :class="{ 'is-invalid': submitted && errors.has('address') }" />
                <div v-if="submitted && errors.has('address')" class="invalid-feedback">{{ errors.first('address') }}</div>
            </div>
            <div class = "form-group">
                <label for="gender">Gender</label>
                <input type="radio" name = "gender" id="one" value="Male" v-model="user.gender" :class="{ 'is-invalid': submitted && errors.has('gender') }" />
                <label for="male">Male</label>
                <input type="radio" name = "gender" id="two" value="Female" v-model="user.gender" :class="{ 'is-invalid': submitted && errors.has('gender') }" />
                <label for="female">Female</label>
                <input type="radio" name = "gender" id="three" value="Other" v-model="user.gender" :class="{ 'is-invalid': submitted && errors.has('gender') }" />
                <label for="other">Other</label>
                <div v-if="submitted && errors.has('gender')" class="invalid-feedback">{{ errors.first('gender') }}</div>
            </div>
            <div class = "form-group">
                <label for="country">Country:</label>
                              <select name = "country" v-model = "user.country" v-validate="'required'" :class="{ 'is-invalid': submitted && errors.has('country') }" >
                                <option> --- </option>
                              ...
                              <div v-if="submitted && errors.has('country')" class="invalid-feedback">{{ errors.first('country') }}</div>
            </div>
            <div class="form-group">
